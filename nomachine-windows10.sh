wget -O ng.sh https://github.com/ardypratamaa/Docker-Ubuntu-Desktop-NoMachine/raw/main/ngrok.sh > /dev/null 2>&1
chmod +x ng.sh
./ng.sh
...
clear
echo "Repo: https://github.com/ardypratamaa/Docker-Ubuntu-Desktop-NoMachine"
echo "======================="
